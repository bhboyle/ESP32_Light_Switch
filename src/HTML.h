...
<head>
  ...
  <style>
    ...
    .input {border:1; padding:10px; border-radius: 8px}
    .input:focus { outline: none !important; border:1px solid red; box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px; } 
