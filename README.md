...
I have added the ability to export the switches configuration. Please note, the passwords like wifi and MQTT passwords are in plain text. This is not a problem for me but you may be concerned about this. I may work on encrypting them in the future but for now they will be in plain text. The import of the config file still needs to be coded.
...
Version 3 of the power board DOES NOT WORK. Well more accurately the energy metering does not work. Do not use it. It blows components all over the place. Now on to version 4...
