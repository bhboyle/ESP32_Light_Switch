...
I have updated the power supply board to unclude a LC filter on the 3.3 volt line. I have tested this yet and it yet put it is a standard LC filter so it should work just fine. I have included an indicator to the schematic if you want to remove the filter from the circuit.
